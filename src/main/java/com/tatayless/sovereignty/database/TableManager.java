...
public class TableManager {
        ...
        private void createMySQLTables(DSLContext context) {
                ...
                context.execute("CREATE TABLE IF NOT EXISTS players (" +
                                ...
                                "role VARCHAR(20), " + // Add role field (e.g., 'president', 'senator', 'soldier',
                                                       // 'citizen')
                ...
                context.execute("CREATE TABLE IF NOT EXISTS trades (" +
                                ...
                                "status VARCHAR(20) NOT NULL DEFAULT 'pending', " + // pending, completed, failed,
                                                                                    // cancelled
                                "consecutive_trades INT NOT NULL DEFAULT 0, " + // Track consecutive trades for power
                                                                                // scaling
                ...
                context.execute("CREATE TABLE IF NOT EXISTS wars (" +
                                ...
                                "required_kills INT NOT NULL, " + // Kills required to win (based on opponent power
                                                                  // level)
        ...
        private void createSQLiteTables(DSLContext context) {
                ...
                context.execute("CREATE TABLE IF NOT EXISTS nation_vaults (" +
                                ...
                                "items TEXT, " + // JSON as TEXT in SQLite - now stores a map of page indexes to item
                                                 // arrays
                ...
                context.execute("CREATE TABLE IF NOT EXISTS trades (" +
                                ...
                                "consecutive_trades INTEGER NOT NULL DEFAULT 0, " + // Track consecutive trades for
                                                                                    // power scaling
                ...
                context.execute("CREATE TABLE IF NOT EXISTS trade_vault_npcs (" +
                                ...
                                "coordinates TEXT NOT NULL, " + // Store as "x,y,z,world"
                                "entity_id INTEGER, " + // Entity ID of the Villager NPC
                                "is_for_sender INTEGER NOT NULL DEFAULT 1, " + // Boolean as INTEGER in SQLite (1 =
                                                                               // true)
                                "created_at TEXT DEFAULT (datetime('now')), " +
                                "updated_at TEXT DEFAULT (datetime('now')), " +
                                "FOREIGN KEY (trade_id) REFERENCES trades(id) ON DELETE CASCADE, " +
                ...
                context.execute("CREATE TABLE IF NOT EXISTS wars (" +
                                ...
                                "required_kills INTEGER NOT NULL, " + // Kills required to win (based on opponent power
                                                                      // level)
